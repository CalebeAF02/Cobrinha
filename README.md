...
Projeto de **estudo em Java**, inspirado no [vídeo do YouTube](https://www.youtube.com/watch?v=GgoEoxW9DQ0&t=1s), com modificações pessoais e o objetivo principal de **aprender a linguagem Java** e praticar conceitos de **programação orientada a objetos (POO)**.
...
Calebe Alves — [github](https://github.com/CalebeAF02)

Luan Freitas - [github](https://github.com/luandkg)
